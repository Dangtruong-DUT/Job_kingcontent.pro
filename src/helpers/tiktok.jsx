...
const TIKTOK_CLIENT_ID = env.VITE_TIKTOK_CLIENT_ID;
const TIKTOK_SCOPE = env.VITE_TIKTOK_SCOPE;
const TIKTOK_REDIRECT_URI = env.VITE_TIKTOK_REDIRECT_URI;
const TIKTOK_CLIENT_SECRET = env.VITE_TIKTOK_CLIENT_SECRET;
