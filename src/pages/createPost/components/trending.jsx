...
const Trending = () => {
    ...
    const { contentTitle, titleObjet, titleChild, chartTrending } = useSelector((state) => state.createPost);
    ...
    const handleGetContentChild = async (keyword) => {
        ...
        const res = await Client.get(`${API_GET_GOOGLE_SUGGESTIONS_DETAIL}?q=${keyword}`);
        if (res.status === OK) {
            dispatch({
                    ...
                    <Tab.Panel>
                        <div className="overflow-scroll overflow-x-hidden max-h-screen mb-20">
                            {contentTitle.length === 0 && !isLoading ? (
                                <div className="flex justify-center">
                                    <span className="font-bold mt-2 mb-2">Không có dữ liệu hiển thị</span>
                                </div>
                                    ...
                                    {titleChildStatus ? (
                                        ...
                                        <>
                                            ...
                                            {contentTitle.length === 0 ? null : (
                                                <button
                                                    className={`w-full ${
                                                        loadingData ? "bg-gray-500" : "bg-blue-500 hover:bg-red-500 "
