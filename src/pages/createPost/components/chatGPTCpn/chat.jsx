...
import { FiCheckCircle, FiMaximize, FiEdit, FiRefreshCcw, FiSave, FiSearch, FiTrash, FiX, FiEye } from "react-icons/fi";
        ...
        return (
            <div className="bg-gray-100 rounded-lg shadow-sm p-3 mb-4">
                <div>
                    ...
                    <TextStyled>
                        <span style={contentStyled} dangerouslySetInnerHTML={{ __html: answer }}></span>
                    </TextStyled>
                </div>
                <div className="flex justify-end gap-5 mt-3">
                    <button onClick={() => handleReplaceQuestion(question, id)} title="Đổi kết quả">
                        <FiRefreshCcw size="25" color="#000" />
                    </button>
                    <button onClick={() => togglePopup(question, answer, id)} title="Xem thêm">
                    ...
                    {isCoppied.status && isCoppied.id === id ? (
                        ...
                        <button title="Đưa vào trình soạn thảo" onClick={() => handleCoppyToClipBoard(answer, id)}>
                    ...
                    <button onClick={() => handleDeteleQuestion(id)} title="Xoá kết quả">
    ...
    return (
        <div className="px-3">
            ...
            <PerfectScrollbar className="w-full mt-4" style={{ maxHeight: "450px" }}>
                ...
                {chatGPTdata.length === 0 && !isLoading && syncRequestPedding.length === 0 ? (
                ...
                {chatGPTdata.length > 0
                    ? [...chatGPTdata]
                          ...
                          .map(({ question, answer, id, isSaved = false }, index) => (
                              <Fragment key={index}>{renderSingleContent(question, answer, id, isSaved)}</Fragment>
                          ))
                    : null}
            </PerfectScrollbar>
