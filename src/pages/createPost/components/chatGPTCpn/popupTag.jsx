...
const PopupTag = ({ isOpen = false, toggle, handleSaveHistory, isContent, setIsContent, isEdit = false }) => {
    ...
    const handleDeleteHashtag = (tag) => {
        confirmAlert({
            title: "Xoá thẻ",
            message: "Bạn có chắc chắn muốn xoá thẻ này không? Chúng tôi sẽ chỉ xoá thẻ của toàn bộ kết quả đã lưu !",
            buttons: [
                {
                    label: "Có",
                    onClick: () => {
                            ...
                            >
                                ...
                                {tagList.length === 0 ? null : (
                                    <div className="relative">
                                        <span className="uppercase text-md font-bold">Thẻ gợi ý</span>
                                        <div
