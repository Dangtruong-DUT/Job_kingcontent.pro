      ...
      {keyWordsHasInContent.length === 0 ? (
        <div className="flex justify-center">
          <span className="font-bold">
            Má»i chuyá»‡n cÃ³ váº» á»•n, chÃºng tÃ´i hiá»‡n chÆ°a tÃ¬m tháº¥y tá»« khÃ³a nÃ o Ä‘Ã¡ng
            ngá» VPCS cá»§a Facebook
          </span>
        </div>
      ) : (
        <div className="p-3 list-disc relative" style={{ minHeight: '200px' }}>
          <span>
            Nhá»¯ng tá»« nÃ y cÃ³ thá»ƒ vi pháº¡m chÃ­nh sÃ¡ch cá»§a facebook khi cháº¡y quáº£ng
            cÃ¡o :
          </span>
