...
import { KEY_LABELS, KEY_SCRIPTED_CREATION } from "@/../reducers/createContent";
...
const PopupSuggTagChatgpt = (props) => {
    ...
    const { [KEY_SCRIPTED_CREATION]: scriptedCreation } = useSelector((state) => state[REDUX_NAME_CREATE_POST]);
