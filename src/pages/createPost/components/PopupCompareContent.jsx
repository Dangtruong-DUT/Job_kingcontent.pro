...
function PopupCompareContent() {
    ...
    var { post_text, source_type, original_content, original_link, media_url, media_type } = useSelector(
    ...
    if (source_type == "special") {
        ...
        contentLeft = (
            <p
                className="text-base overflow-auto leading-loose"
        ...
        contentLeft = (
            <>
                ...
                ></p>
                {media_type == "video" ? renderVideo(media_url) : null}
            </>
        );
        contentRight = (
            <>
                ...
                ></p>
                {media_url != null ? renderVideo(media_url) : <LoadingApp />}
            </>
        );
    }
    ...
    return (
        <div className="bg-createContent-modalOverLayClr z-9999 fixed inset-0 flex items-center justify-center">
            ...
            <div
                className="mx-20 px-2 mt-4 bg-white rounded-md relative justify-center overflow-auto"
                style={{ height: "80%" }}
            >
