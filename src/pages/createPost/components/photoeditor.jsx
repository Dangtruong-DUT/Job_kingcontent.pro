...
const CanvasContainer = styled.div`
    ...
    height: 100%;
`;
const PhotoEditor = ({ setIsEditor, images, setImages, isRightImage = false }) => {
    ...
    function mouseRotateIcon(angle) {
        ...
        const pos = {
            ...
            defaultPos = "7.25 10";
        const transform =
            relativeAngle === 0 ? "translate(9.5 3.5)" : `rotate(${relativeAngle} ${pos[relativeAngle] || defaultPos})`;
    ...
    try {
        ...
        const fallbackSvg =
            '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="9" r="8" fill="white" stroke="black"/><text x="9" y="9" text-anchor="middle" dy="0.3em" font-size="10">R</text></svg>';
    ...
    const renderItemForTool = () => {
        switch (toolSelect) {
            ...
            case IMAGE:
                return <Images onUploadImage={onUploadImage} fabric={fabric} editor={editor} />;
            case TEXT_TOOL:
                return (
                    <Text
                        editor={editor}
            ...
            case DRAW:
                return (
                    <Draw editor={editor} canvas={canvas} removeObject={removeObject} setLayerStatus={setLayerStatus} />
                );
            case CLIP_PATH:
                return (
                    <ClipPath
    ...
    useEffect(() => {
        if (
            location.pathname !== "/chinh-sua-anh" &&
            initalImage &&
            editor &&
    ...
    return (
        <div className="flex bg-white rounded-lg P-1 mb-5 absolute left-0 top-0 w-full z-9999">
            ...
            <div className="w-full  h-15">
                ...
                <div style={{ backgroundColor: "#ebecf0" }} className="py-5 h-screen overflow-auto">
