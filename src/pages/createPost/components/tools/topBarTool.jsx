...
const TopBarTool = ({ editor, type, allFonts }) => {
    ...
    useEffect(() => {
        if (editor && editor.canvas.getActiveObject() && !isArrayEmpty(editor.canvas.getObjects())) {
            ...
            editor.canvas.getActiveObject().type === "i-text" ? (
                <div className="flex gap-x-3 items-center">
                    ...
                    <div onClick={() => addItalics(2)} color="#2d1be4" tooltip="Italic">
                        <FontAwesomeIcon style={{ fontSize: "20px", color: "#000000" }} icon={faItalic} />
                    </div>
                    <div onClick={() => addBold(3)} className="item" color="#2d1be4" tooltip="Bold">
                        <FontAwesomeIcon style={{ fontSize: "20px", color: "#000000" }} icon={faBold} />
                    </div>
                    ...
                    {editor.canvas.getActiveObject() && (
                        <div>
                            {alignIcon === "L" ? (
                                <FaAlignLeft onClick={() => alignText("L")} size={30} color="#000" />
                            ) : alignIcon === "R" ? (
                                <FaAlignRight onClick={() => alignText("R")} size={30} color="#000" />
                            ) : (
                                <FaAlignJustify onClick={() => alignText("VH")} size={30} color="#000" />
                            )}
                        </div>
                    )}
                </div>
