...
const ScheduleSettings = (props) => {
    ...
    const [selectedDateTime, setSelectedDateTime] = useState(moment().add(7, "minutes"));
    ...
    const { listDestinations = null, isDestinationLoading = false } = useSelector((state) => state.schedules);
    ...
    const onClickDestination = (destinationId, type) => {
        ...
        if (searchResult.length) {
            ...
            setSelectedDestinations([...selectedDestinations, { id: destinationId, type }]);
        }
    };
