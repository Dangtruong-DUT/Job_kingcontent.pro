...
import { actionGetGoogleSubjects, actionResetState } from "@/store/actions/createContent";
                    ...
                    <div className="w-full p-2">
                        <Tab.Group>
                            ...
                            <Tab.Panels className="mt-2">
                                <Tab.Panel>
                                    <TabLeft typeSug={statusSelect} api={API_EDIT_SUGGEST_KEYWORD_GG} query={"title"} />
                                </Tab.Panel>
                                <Tab.Panel>
                                    <TabRight
