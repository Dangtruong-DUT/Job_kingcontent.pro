...
import { KEY_PLANS, KEY_PLAN_SELECT } from "@/reducers/createContent";
import {
    actionGetPlans,
    actionUpdateStep1,
    actionUpdateStep2,
...
import { lineGadientReg } from "@/utils/utilityFunc";
...
const PoupPlan = ({ isOpen = true }) => {
    ...
    const rightPlanList = ["Bất động sản", "Nhà", "Xe các loại", "Vui cười , giải trí"];
        ...
        confirmAlert({
            ...
            message: (
                <span className="warning-content">
                    Bạn có chắc chắn muốn xoá kế hoạch này không? Nếu xoá toàn bộ content bên trong sẽ bị xoá mà không
                    thể phục hồi!
                </span>
            ),
            buttons: [
                                                            ...
                                                            {isLinegadient || thumbnail !== null ? (
                                                                ...
                                                                >
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        onClick={() => handleSelectPlan({ name, id })}
                                                                    >
                                                                        {name} ({contents_count})
                                                                    </span>
                                                                    {hashtag && (
