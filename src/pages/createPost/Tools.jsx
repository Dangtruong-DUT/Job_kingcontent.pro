...
import { changeStateFeedbacksForm, resetFeedbackData } from "@/store/actions/editor/editorActions";
...
const Tools = ({ titleType, setTitleType, setIsEditor, images, setImages, setIsRightImage, setImagesRightEditor }) => {
    ...
    const renderContentType = () => {
        switch (titleType) {
            ...
            case UPLOAD:
                return <Upload setIsEditor={setIsEditor} images={images} setImages={setImages} />;
    ...
    return (
        <div className="bg-gray-50 rounded-md  text-sm overflow-hidden py-2" style={{ minHeight: "80%" }}>
            ...
            {titleType === DEFAULT ? (
                ...
                <ContentDataStyled className="overflow-auto">{renderContentType()}</ContentDataStyled>
            )}
        </div>
    );
};
