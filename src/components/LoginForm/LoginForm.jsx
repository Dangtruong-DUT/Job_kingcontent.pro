...
import { loginFBFunction, loginFunction, registerFunction } from "@/store/actions/user";
...
const LoginForm = (props) => {
    ...
    return (
        <div className="w-full">
            <form
                className="w-full"
                onSubmit={typeForm === LOGIN ? handleSubmit(onSubmit) : handleSubmit(registerSubmit)}
                autoComplete="off"
            >
                        ...
                        <Fragment>
                            <div className="mb-4">
                                <FormGroup>
                                    ...
                                    {/* Error validate */}
                                    {errors.user_name && (
                                        <FormFeedback className="text-red-500 pt-2" invalid-feedback="true">
                    ...
                    <div className="mb-4 px-2 cursor-pointer">
                        ...
                        {typeForm === LOGIN ? (
                            ...
                            <label htmlFor="remember" className="font-medium cursor-pointer">
                                ...
                                <span className="underline" onClick={(e) => onClickTermConditions(e)}>
                    ...
                    {typeForm === LOGIN && (
                        <>
                            ...
                            <div className="mt-2 text-red-500 italic text-sm">
                                * Kingcontent lÃ  á»©ng dá»¥ng Ä‘Æ°á»£c Facebook chÃ­nh thá»©c cáº¥p quyá»n hoáº¡t
                                Ä‘á»™ng, tuy nhiÃªn báº¡n cÃ³ thá»ƒ sá»­ dá»¥ng tÃ i khoáº£n phá»¥ Ä‘á»ƒ Ä‘Äƒng nháº­p
                                vÃ  tá»± chá»‹u trÃ¡ch nhiá»‡m báº£o máº­t.
                            </div>
