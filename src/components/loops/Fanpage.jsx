        ...
        >
            ...
            <div className="flex justify-center">
                <div className="h-28 w-28 rounded-full shadow-sm mb-3 p-1 border border-solid border-gray-100">
                    <img className="h-full w-full rounded-full overflow-hidden" src={baseURL + fpThumbnail} />
                </div>
            </div>
            <div className="font-bold">
                <h5 className="truncate mb-3 text-center  text-sm text-gray-700">{fanpage.name}</h5>
                <div className="flex justify-center">
