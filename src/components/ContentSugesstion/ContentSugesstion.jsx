...
import { actionGetPostByKeyword, actionResetState, toggleEditorText } from "@/store/actions/createContent";
                    ...
                    <table className="relative w-full">
                        <thead className="bg-white z-10">
                            <tr className="bg-white z-10">
                                <th className="sticky top-0 px-6 py-3 bg-white z-10">Máº«u cÃ¢u</th>
                                <th className="sticky top-0 px-6 py-3 bg-white min-w-52">ÄÃ£ dÃ¹ng</th>
                            </tr>
                        </thead>
                                ...
                                {posts
                                    ...
                                    .map((_elt, index) => (
                                        <tr
                                            ...
                                            onClick={() => dispatch(toggleEditorText(_elt?.title))}
                                        >
                                            <td className="px-6 py-4 text-left cursor-pointer">
                                                <p dangerouslySetInnerHTML={{ __html: _elt.title }} className=""></p>
                                            </td>
