...
const SingleCategory = (props) => {
    ...
    let { posts_count: countContents = 0, cate_name = "", cate_url, cate_id, tags = [] } = category;
    ...
    return (
        <div className="bg-white shadow-smBlackShadow rounded-md overflow-hidden p-3 cursor-pointer group">
