...
import { FaCalendarAlt, FaComment, FaEye, FaHeart, FaPencilAlt, FaPlayCircle } from "react-icons/fa";
            ...
            if (search) {
                filteredVideos = filteredVideos.filter(
                    (video) =>
                        ...
                        video?.video_description?.toLowerCase().includes(search.toLowerCase())
                );
            }
            if (dateOrder) {
            ...
            {isLoadingMyVideos ? (
                ...
                <div className="flex flex-col">
                    ...
                    <div className="quickFilter">
                        <label className="mb-2 pl-1 font-bold">Lọc, sắp xếp nhanh bài viết</label>
                        {/* search box */}
