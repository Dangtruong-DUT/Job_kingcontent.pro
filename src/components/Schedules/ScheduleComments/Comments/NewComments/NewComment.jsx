        ...
        <div className="commentItem flex gap-3 items-center text-center mb-2">
            ...
            <div className="w-2/12">
                <Checkbox
                    ...
                    inline={true}
                    onChange={(value, checked) => onChangeComment(comment?.id, "is_random_characters", checked)}
                />
            </div>
            <div className="w-2/12 text-center">
                <Checkbox
                    ...
                    className="text-center"
                    inline={true}
                    onChange={(value, checked) => onChangeComment(comment?.id, "is_random_emojis", checked)}
                />
            </div>
            <div className="w-2/12">
                <button
