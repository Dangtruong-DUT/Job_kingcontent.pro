...
const ScheduleActions = (props) => {
    ...
    const handlePause = () => {
        confirmAlert({
            ...
            message:
                "Bạn có chắc chắn muốn tạm dừng tất cả các bài đã chọn? Lưu ý: chúng tôi sẽ chỉ tạm dừng các bài đã chọn và đang ở trạng thái chờ lên bài.",
            buttons: [
                {
                    label: "Đồng ý",
                    onClick: () => {
    ...
    const handlePlay = () => {
        confirmAlert({
            ...
            message:
                "Bạn có chắc chắn muốn tiếp tục đăng tất cả các bài đã chọn? Lưu ý: chúng tôi sẽ chỉ đăng bài đã chọn và đang ở trạng thái tạm dừng.",
            buttons: [
                {
                    label: "Đồng ý",
                    onClick: () => {
    ...
    return (
        <div className="flex gap-2 items-center">
            {/* total selected */}
            <p>
                Bạn đã chọn <span className="font-bold">{listSelected.length}</span> /{" "}
