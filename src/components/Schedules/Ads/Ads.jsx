...
const Ads = (props) => {
    ...
    const { searchADSData = null, keyword = "" } = useSelector((state) => state.adsRunning);
    ...
    useEffect(() => {
        if (searchADSData) {
            const { collection_token = "", forward_cursor = "", results = [] } = searchADSData;
            setContents(results);
    ...
    const handleLoadMore = useCallback(() => {
        dispatch(actionSearchADS(keyword, setIsLoading, collectionToken, forwardCursor));
