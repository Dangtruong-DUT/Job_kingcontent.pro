...
const ScheduleItemPopup = (props) => {
    ...
    const { showScheduleItemPopup = false, scheduleItemPopupToShow = null } = useSelector((state) => state.schedules);
                ...
                <div className="tabs flex flex-nowrap w-full border-b border-solid border-gray-300 ml-3 pb-1">
                    <div
                        ...
                        className={`group cursor-pointer inline-block px-3 py-2 ml-0.5 rounded-t-md font-bold select-none text-base uppercase border hover:bg-blue-500 hover:text-white ${
                            isShowContent ? "bg-blue-500 text-white" : "bg-white text-blue-500"
                        } border-gray-300`}
                    >
                    ...
                    <div
                        ...
                        className={`group cursor-pointer inline-block px-3 py-2 ml-0.5 rounded-t-md font-bold select-none text-base uppercase border hover:bg-blue-500 hover:text-white ${
                            isShowComments ? "bg-blue-500 text-white" : "bg-white text-blue-500"
                        } border-gray-300`}
                    >
                        <div className="flex items-center gap-2">
                ...
                {isShowComments && (
                    <div className="commentsContainer w-full p-3">
                        <Comments
                            ...
                            is_posted={scheduleContent?.status === 1 || scheduleContent?.status === 5}
