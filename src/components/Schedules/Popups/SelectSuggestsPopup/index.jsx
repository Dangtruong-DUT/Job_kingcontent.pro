...
function SelectSuggestsPopup(props) {
    ...
    const showSelectSuggestsPopup = useSelector((state) => state.schedules.showSelectSuggestsPopup);
    ...
    return (
        <div className="min-w-screen h-screen fixed inset-0 z-9999 flex items-center justify-center">
            ...
            >
                ...
                />
                <span className="text-gray-800 text-base font-bold p-1">Lựa CHỌN GÓI Ý PHÙ HỢP Ý TƯỞNG CỦA BẠN</span>
