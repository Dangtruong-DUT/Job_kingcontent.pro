...
const ScheduleMultipleItemsPopup = (props) => {
    ...
    const { scheduleMultipleItemsToShow = null } = useSelector((state) => state.schedules);
    ...
    const handleActionShowPopup = (scheduleContent) => {
        const { content_id = "", source_type = "", source_content = null, status = 0 } = scheduleContent;
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-9999">
            ...
            />
            <PerfectScrollbar
                className={`bg-white max-w-2xl w-full m-auto rounded-md outline-none border-0 shadow-md py-3 pl-3 pr-8 pt-8 transform origin-center max-h-schedule relative overflow-x-hidden ${
            ...
            >
                ...
                {contents &&
                    ...
                    contents.map((content, index) => {
                        ...
                        return (
                            <div key={index} className="flex flex-nowrap relative my-1 border rounded-md">
                                <InfoLeft
