...
function SuggestionItem(props) {
    ...
    return (
        <li className="bg-white p-2 flex items-center justify-between rounded-md mx-2 my-2 cursor-default">
            <div className="flex items-center mr-2 cursor-pointer w-full" onClick={handleShowContent}>
                ...
                <div>
                    <div className="flex flex-nowrap">
                        <h3 className="text-sm text-blue-700 font-bold">{fanpage?.name || ""}</h3>
                    </div>
                    <p
            ...
            <div className="flex flex-nowrap">
                <div className="inline-flex items-center mr-2">
                    <div className="flex items-center mx-2">
                        ...
                        <span className="ml-1 text-gray-800 font-medium">{numberWithCommas(likes)}</span>
                    </div>
                    <div className="flex items-center mx-2">
                        <FaCommentDots className="h-4 w-4 text-gray-400" />
                        <span className="ml-1 text-gray-800 font-medium">{numberWithCommas(comments)}</span>
                    </div>
                    <div className="flex items-center mx-2">
                        <FaShare className="h-4 w-4 text-gray-400" />
                        <span className="ml-1 text-gray-800 font-medium">{numberWithCommas(shares)}</span>
                    </div>
                </div>
