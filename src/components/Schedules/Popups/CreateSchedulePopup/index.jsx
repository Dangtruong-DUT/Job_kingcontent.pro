...
function CreateSchedulePopup(props) {
    ...
    const suggestionContent = useSelector((state) => state.schedules.suggestionContent);
    ...
    const { video_source, content_type, post_timestamp, fanpage, medias, content } = suggestionContent;
    ...
    return (
        <div className="min-w-screen h-screen fixed inset-0 z-9999 flex items-center justify-center">
            <div onClick={closeForm} className="absolute inset-0 bg-black opacity-20" />
            <div className="w-full max-w-5xl relative m-auto rounded-lg shadow-lg bg-gray-200 p-3 md:mt-16 mt-12">
                ...
                <div className="m-2 flex flex-col ">
                    <div className="flex items-center mb-2">
                        <ImArrowLeft onClick={handleBack} className="w-7 h-7 mr-3 text-gray-600 hover:text-blue-400" />
                        <span className="text-gray-800 font-bold text-base p-1">SOẠN THẢO NỘI DUNG CẦN LÊN LỊCH</span>
                    </div>

                    {/* <div className="bg-white w-full max-h-52 h-52 border-0 outline-none p-2 ring-1 ring-blue-300 overflow-y-auto"
            contentEditable="true"
            placeholder="HÃ£y viáº¿t gÃ¬ vÃ o Ä‘Ã¢y hoáº·c chuyá»ƒn cÃ¡c Ã½ tÆ°á»Ÿng bÃªn cáº¡nh Ä‘á»ƒ chá»‰nh sá»­a ..."
