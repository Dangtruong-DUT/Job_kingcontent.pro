...
const SelectCategories = (props) => {
    const { changeStateCategoriesPopup, getParentCategories, selectedCat } = props;
    ...
    const handleSaveButton = useCallback(() => {
        if (selectedCat?.id) {
            ...
            alert("Vui lÃ²ng chá»n má»™t cate Ä‘á»ƒ chÃºng tÃ´i lá»c káº¿t quáº£ tá»‘t nháº¥t");
        }
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex items-start justify-between px-2 py-4 border-b border-solid border-gray-300 rounded-t">
                            <h3 className="text-xl font-semibold text-center flex items-center text-gray-700 ">
                                ...
                                Chá»n chá»§ Ä‘á» báº¡n Ä‘ang quan tÃ¢m
                            </h3>
                        </div>
                        {/*body*/}
