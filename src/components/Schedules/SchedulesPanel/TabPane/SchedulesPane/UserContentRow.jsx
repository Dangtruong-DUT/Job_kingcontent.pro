...
const stylesContentType = [
  { icon: FaCheckCircle, name: 'ThÃ nh cÃ´ng', bgColor: 'bg-greenSuccess' },
  { icon: AiOutlineFieldTime, name: 'Äang chá»', bgColor: 'text-gray-500' },
  { icon: FiPauseCircle, name: 'Äang táº¡m dá»«ng', bgColor: 'text-red-500' },
  { icon: FaMinusCircle, name: 'ÄÃ£ huá»·', bgColor: 'bg-redQuestion' },
  { icon: FaCheck, name: 'ThÃ nh cÃ´ng', bgColor: 'bg-greenSuccess' },
  { icon: FaExclamation, name: 'ÄÃ£ cÃ³ lá»—i', bgColor: 'text-red-500' },
];
