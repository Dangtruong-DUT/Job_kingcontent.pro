...
const renderUserContent = () => {
    ...
    for (let i = 0; i <= 23; i++) {
        const hour = nextHour.getHours() < 10 ? "0" + nextHour.getHours() : nextHour.getHours();
...
const UserContents = (props) => {
    ...
    const { valueMonday, valueSunday, currentSchedule = null } = useSelector((state) => state.schedules);
