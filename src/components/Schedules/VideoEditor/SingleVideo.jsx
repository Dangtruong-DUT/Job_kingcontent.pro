        ...
        >
          {thumbnail ? (
            ...
            <div className="w-full h-full bg-gray-300 rounded-lg flex items-center justify-center">
              <span className="text-gray-500">KhÃ´ng cÃ³ video</span>
            </div>
          )}
        </div>
        <div
          ...
          role="button"
        >
          <h3>Hash tag: {hash_tag ? <span className="font-bold">{hash_tag}</span> : <span className="italic">ChÆ°a thÃªm hash tag</span>}</h3>
          <div className="overflow-hidden max-h-28">
            {description ? 
              ...
              ></p> : 
              <p className="italic">ChÆ°a thÃªm mÃ´ táº£ cho video</p>
            }
          </div>
