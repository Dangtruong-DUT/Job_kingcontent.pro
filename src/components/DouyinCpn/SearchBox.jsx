...
import { commentTypeOptions, orderTypeOptions, scheduleOptions, shareTypeOptions } from "./constants";
...
const SearchBox = (props) => {
    ...
    const videoTypeOptions = [
        ...
        {
            label: "Chuáº©n Reels (nhá» nháº¥t 540x960)",
            value: 1,
        },
        {
            label: "KhÃ´ng chuáº©n Reels",
            value: 2,
        },
    ];
    const {
            ...
            case "schedule":
                const newDataSchedule = searchVideos.videos.filter((item) => {
                    const search = scheduledContents.find(
                        (elt) => elt?.content_id === item?.video_id && elt?.source_type === "douyin"
                    );
            ...
            <form className="flex gap-3 pt-3 mb-3" onSubmit={onSearch}>
                ...
                <div className="flex items-center w-2/3 relative">
                    <input
                        ...
                        placeholder="Vui lÃ²ng nháº­p tá»« khÃ³a báº±ng tiáº¿ng TRUNG hoáº·c tiáº¿ng ANH Ä‘á»ƒ tÃ¬m káº¿t quáº£ tá»‘t nháº¥t"
                        value={inputValue}
