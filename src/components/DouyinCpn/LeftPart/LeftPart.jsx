                    ...
                    <Fragment>
                        ...
                        {filteredChannels?.length > 0 ? (
                            ...
                            <h3 className="font-bold px-2 text-center mt-5">
                                Báº¡n chÆ°a theo dÃµi kÃªnh Douyin nÃ o Hoáº·c khÃ´ng tÃ¬m tháº¥y kÃªnh
                            </h3>
                        )}
                    </Fragment>
                ) : null}
                            ...
                            <div className="list_collection max-h-screen overflow-auto">
                                {collections?.map((collection) => (
                                    <Fragment key={collection.id}>
                                        <SingleCollection collection={collection} isSchedule={isSchedule} />
                                    </Fragment>
                                ))}
                            </div>
                        ) : (
                            <h3 className="font-bold px-2 text-center mt-5">
                                Báº¡n chÆ°a táº¡o bá»™ sÆ°u táº­p Douyin nÃ o
                            </h3>
                        )}
                    </div>
                ) : (
