...
import { actionGetUserPosts, actionGetUserReels, actionSetCurrentContentType } from "@/store/actions/instagram";
...
const UserContents = (props) => {
    ...
    useEffect(() => {
        if (currentContentType === "post" && posts === null && currentUser && currentUser.username) {
