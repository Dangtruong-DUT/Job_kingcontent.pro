...
const UserPosts = (props) => {
    ...
    }, [posts, loadingFeeds, nextIsLoading, orderDir, orderType, scheduleFilter, scheduledContents]);
    ...
    return (
        <div>
            {listPosts.length > 0 ? (
                <div className={`grid gap-1 mt-3 ${isSchedule ? "grid-cols-2" : "grid-cols-2"}`}>
            ...
            {!loadingFeeds && !nextIsLoading && listPosts.length > 0 && posts?.has_next && (
