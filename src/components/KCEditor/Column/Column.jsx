...
const Column = (props) => {
    ...
    const onSearchCreatedContents = useCallback(
        (value) => {
            if (value) {
                const filterData = contents.filter((item) => {
                    if (item.content.toLowerCase().includes(value)) return true;
                    return false;
                });
                setData(filterData);
            } else {
    ...
    return (
        <>
            ...
            >
                ...
                <ColumnSearchCreated type={type} onSearchCreatedContents={onSearchCreatedContents} />
