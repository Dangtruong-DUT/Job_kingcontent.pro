...
import SingleSuggestion from "./SingleSuggestion/SingleSuggestion.jsx";
import PerfectScrollbar from "react-perfect-scrollbar";

const SuggestionContents = (props) => {
    const { type, contents, addContentToEditor = () => {} } = props;
    ...
    useEffect(() => {
        switch (type) {
            case "feedback":
                setTitle("Máº«u Feedback");
                break;
            case "trend":
                setTitle("BÃ i viáº¿t má»›i nháº¥t");
                break;
            case "special":
                setTitle("BÃ i viáº¿t má»›i nháº¥t");
                break;
    ...
    return (
        <div className="suggestion-contents mt-2 mb-2 p-1">
            ...
            <div className="text-center" onClick={() => loadMoreSgs()}>
                Xem thêm
            </div>
        </div>
    );
