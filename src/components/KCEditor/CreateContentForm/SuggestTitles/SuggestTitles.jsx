...
const listTitles = [
    ...
    },
    {
        ...
        keywords: ["khuyến mãi", "giảm giá", "nay chỉ còn", "tặng ngay", "tặng kèm", "quà tặng", "giá chỉ"],
    },
    {
        id: 5,
        color: "trend",
    ...
    return (
        <div className="suggestion-steps flex whitespace-nowrap flex-nowrap w-full gap-1">
            {listTitles.map((title, index) => {
                const { color, number, text, description_text, description_title } = title;
                ...
                return (
                    ...
                    >
                        <span className="number rounded-full bg-white text-black px-2 py-1">{number}</span>
                        ...
                        >
                            <p className="whitespace-pre-line font-bold text-base mb-2">{description_title}</p>
