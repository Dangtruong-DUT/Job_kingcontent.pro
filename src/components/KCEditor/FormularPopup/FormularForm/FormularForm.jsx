          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              <h3 className="text-3xl font-semibold">
                Táº¡o content theo cÃ´ng thá»©c
              </h3>
              <XIcon
            ...
            <PerfectScrollbar className="relative p-6 flex-auto max-h-96">
              <p className="my-4 text-blueGray-500 text-base leading-relaxed">
                ...
                themselves. If you're taught you canâ€™t do anything, you wonâ€™t do
                anything. I was taught I could do everything. I always felt like
                I could do anything. Thatâ€™s the main thing people are controlled
                by! Thoughts- their perception of themselves! They're slowed
                down by their perception of themselves. If you're taught you
                canâ€™t do anything, you wonâ€™t do anything. I was taught I could
                do everything.
              </p>
            </PerfectScrollbar>
            {/*footer*/}
