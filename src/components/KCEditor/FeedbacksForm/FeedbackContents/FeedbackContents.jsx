    ...
    return (
        <div className="w-full bg-white p-3 rounded-md">
            ...
            <div className="searchBar flex my-3 gap-2 items-center">
                <input type="text" placeholder="Tìm kiếm" className="w-full border border-gray-300 rounded-md p-2" />
                <ByItemsSelect
                    childCategories={childCategories}
                    onCategoriesSelected={onCategoriesSelected}
                    selectedCatId={catId}
                />
                <button className="bg-blue-500 text-white rounded-md p-2 w-1/6">Tìm</button>
            </div>
