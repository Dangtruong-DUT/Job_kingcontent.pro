...
import FeedbackType from "@/components/KCEditor/FeedbacksForm/FeedbackType";
import FeedbackTypes from "@/components/KCEditor/FeedbacksForm/FeedbackTypes";
import SaveFeedback from "@/components/KCEditor/FeedbacksForm/SaveFeedback";
                ...
                <div className="relative w-5/6 my-6 mx-auto">
                    ...
                    >
                        <PerfectScrollbar className="">
                            ...
                            {feebackImage && false && (
                                <SaveFeedback feebackImage={feebackImage} setFeebackImage={setFeebackImage} />
                            )}
                        </PerfectScrollbar>
                    </div>
                </div>
