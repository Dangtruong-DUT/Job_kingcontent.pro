...
const FeedbackType = (props) => {
    ...
    const { feedbacksType = null, currentFeedback = 0 } = useSelector((state) => state.editor);
        ...
        <div className="flex gap-3">
            <div className="w-feedback">
                ...
                <div className="app_main w-feedback mx-auto relative">
                    ...
                    {isShowModalTime && <ModalNewTime setIsShowModalTime={setIsShowModalTime} />}

                    {isShowSettingsForm && <SettingsForm setIsShowSettingsForm={setIsShowSettingsForm} />}
                </div>
            </div>
            <FeedbackContents />
        </div>
