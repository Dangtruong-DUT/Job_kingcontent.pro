      ...
      <div className="formNewFeedBack w-3/5 mr-4">
        <div className="flex">
          ...
          <div className="editor w-10/12">
            <textarea className="w-full border-0 rounded-md outline-none p-5" placeholder="HÃ£y viáº¿t gÃ¬ Ä‘Ã³ cho feedback nÃ y..." onChange={e => handleOnChange(e.target.value)}></textarea>
          </div>
        </div>
        <div className="actions w-full text-right mt-3">
          <button className="inline-block bg-blue-500 rounded-lg text-white py-2 px-3 mr-2" onClick={e => handleOnSubmit()}>LÆ°u bÃ i viáº¿t</button>
          <button className="inline-block bg-blue-500 rounded-lg text-white py-2 px-3">ÄÄƒng lÃªn FB</button>
        </div>
      </div>
