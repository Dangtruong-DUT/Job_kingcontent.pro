...
const Card = ({ contents, setIsOpen, setItem }) => {
    ...
    const handleWriteContent = (item) => {
        ...
        dispatch(
            actionPushContentToCreateContentScreen(postText, medias, mediaType, item?.wishlist === 1 ? true : false)
        );
    };
        ...
        <CardStyled className="grid gap-x-2 gap-y-4 grid-cols-3">
            {contents &&
                ...
                contents.map((_elt, index) => (
                    <div
                        key={index}
                        className={`${_elt.medias.length === 0 ? "hidden" : ""} rounded-lg border w-full
                        ...
                        <div className="pr-3 pl-3 pt-3 ">
                            <div className="flex items-center w-full">
                                ...
                                <div className="flex flex-col w-full">
                                    <span className="pt-1 ml-2 font-bold text-base">{_elt?.user_screenname}</span>
                        ...
                        <div className="card-action bg-gray-300 w-full h-full transition-all">
                            <div className="flex justify-center items-center flex-col">
                                <div>
                                    ...
                                    >
                                        <span>
                                            <img src={ViewIcon} alt="" className="w-12 bg-white rounded-full" />
                                        </span>
                                    ...
                                    >
                                        <img src={EditIcon} alt="" className="w-12 bg-white rounded-full" />
                                    ...
                                    >
                                        <img src={CalendarIcon} alt="" className="w-12 bg-white rounded-full" />
                                    ...
                                    >
                                        <img src={UnfollowIcon} alt="" className="w-12 bg-white rounded-full" />
            ...
            <PopupDetailContentPlan isOpen={isOpen} item={itemView} setIsOpenDetail={setiIsOpen} showTool={false} />
        </CardStyled>
    );
};
