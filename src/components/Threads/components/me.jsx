...
const Me = (props) => {
    ...
    const applyFilter = () => {
        if (myPosts) {
            ...
            if (search) {
                filteredPosts = filteredPosts.filter((post) => post.text.toLowerCase().includes(search.toLowerCase()));
            }
            if (mediaType !== "all") {
                filteredPosts = filteredPosts.filter((post) => post.media_type === mediaType);
            }
            if (dateOrder) {
        ...
        <div>
            {isLoadingMyPosts ? (
                ...
                <div className="flex flex-col">
                    ...
                    {isShowComments ? <ListComments {...{ setIsShowComments, currentPost, setCurrentPost }} /> : null}
                </div>
            )}
        </div>
    );
