...
import Header from "../CategoriesContent/ContentDetailThreads/Header.jsx";
import {
    FaCheckSquare,
    FaClock,
    FaComment,
...
import { FiMessageCircle, FiPlay, FiRefreshCcw, FiThumbsUp } from "react-icons/fi";
import {
        ...
        <div className="singleThread">
            {isSchedule ? (
                ...
                <div className="flex flex-col gap-2 p-3 mb-2 group relative border-2 border-gray-200 rounded-lg shadow-md">
                    <Header fanpageName={user_name} page_avatar={user_picture} created={created} />
                                ...
                                {actions.map((item, index) => (
                                    ...
                                    >
                                        {item.action === "CHOOSE_VIDEO" && isChosen ? (
                                            <FaCheckSquare color="green" className="w-6 h-6 text-gray-100 bg-white" />
                                        ) : (
                                        ...
                                        <a className="no-underline text-base font-medium text-gray-100 hover:text-white transition-all duration-200 ease-linear">
                                            {item.action === "CHOOSE_VIDEO" && isChosen ? "Bỏ chọn" : item.title}
                                        </a>
                                    </li>
                                ))}
                            </ul>
