...
const ListVideos = () => {
  ...
  const handleDeleteVideo = (id) => {
    confirmAlert({
      ...
      message: "Báº¡n cÃ³ cháº¯c cháº¯n muá»‘n xÃ³a video nÃ y? HÃ nh Ä‘á»™ng nÃ y khÃ´ng thá»ƒ hoÃ n tÃ¡c.",
      buttons: [
        {
          label: "XÃ³a",
          onClick: () => {
      ...
      <div className="space-y-6 mb-3">
        ...
        {videos.length > 0 && (
          <div className="text-center text-sm text-gray-600">
            Hiá»ƒn thá»‹ {videos.length} / {pagination.total} video
          </div>
        )}
        ...
        {videos.length === 0 && hasInitialized && (
          <div className="text-center py-12">
            <div className="text-gray-500 text-lg">ChÆ°a cÃ³ video nÃ o</div>
            <div className="text-gray-400 text-sm mt-2">HÃ£y táº¡o video Ä‘áº§u tiÃªn cá»§a báº¡n</div>
          </div>
        )}
      </div>
