...
import CategoriesContentItem from "@/components/CategoriesContent/CategonesContentltem";
import "./style.css";
import { useDispatch, useSelector } from "react-redux";
import { saveLikedData, updateLikedData } from "@/store/actions/user";
import PopupTag from "@/components/CategoriesContent/CategonesContentltem/hashtagPopup";
...
function GridLayoutContent(props) {
    ...
    const handleUpdateHashTag = (tag) => {
        dispatch(
            updateLikedData(contentSelect.id, { hashtag: tag, user_id: user.id }, togglePopupTag, reactiveGetLikedData)
        );
    };
    useEffect(() => {
    ...
    return (
        <>
            ...
            <PopupTag
                ...
                onSubmitClick={location.pathname === PATH_NAME_CONTENT_LIKED ? handleUpdateHashTag : handleLikePost}
