...
function SearchAndFilter(props) {
    const { handleSearch, fanpage_id, getAllPost, fanpageSelectList, setQuerySaved, handleSearchFunction, cateId } =
        props;
    ...
    const onSearch = () => {
        ...
        valueNumsLike !== "" && (query += handleSelectLikeCommentShare(valueNumsLike, "like", setRelationShipFilter));
        valueNumsComment !== "" &&
            (query += handleSelectLikeCommentShare(valueNumsComment, "comment", setRelationShipFilter));
        valueNumsShare !== "" &&
            (query += handleSelectLikeCommentShare(valueNumsShare, "share", setRelationShipFilter));
        valueFreqLike !== "" && (query += handleSelectSort(valueFreqLike, "likes", 0, setRelationShipFilter));
        valueFreqComment !== "" && (query += handleSelectSort(valueFreqComment, "comments", 1, setRelationShipFilter));
        valueFreqShare !== "" && (query += handleSelectSort(valueFreqShare, "shares", 2, setRelationShipFilter));
        valueFreqTime !== "" && (query += handleSelectSort(valueFreqTime, "post_timestamp", 4, setRelationShipFilter));
        freqKeywordFilter !== "" && (query += handleSelectNumberKeyword(freqKeywordFilter, "words_count"));
    ...
    return (
        <div className="my-3 px-2 py-3 rounded-lg bg-white shadow-sm searchAndFilter relative z-20">
            <div className="flex gap-3">
                <InputKeyWords keywordsToSearch={keywordsToSearch} getAllPost={getAllPost} onSearch={onSearch} />
                <div className="flex items-center gap-3">
                    ...
                    <ShowHideSearchFilterButton onClick={onClickShowHideSearchFilterButton} />
                </div>
            </div>
            ...
            >
                ...
                <div className="my-1 grid lg:grid-cols-2 grid-cols-2 ">
                    <div className="my-0.5 flex items-center justify-between flex-wrap flex-grow ">
                        ...
                        <KindOfContentSelect kindOfContentToSearch={kindOfContentToSearch} />
                    </div>
                    <div className="my-0.5 flex items-center justify-between flex-wrap w-full">
                        <DatePickerToSearch fromDateSearch={fromDateSearch} toDateSearch={toDateSearch} />
              ...
              >
                ...
                <>
                    ...
                    <div>
                        ...
                        <div className="mt-1 mb-3 grid lg:grid-cols-3 grid-cols-1 gap-3 " id="filter">
                            <ByLikeSelect
                    ...
                    <>
                        <div className="mb-3">
                            ...
                            <div className="mt-1 mb-3 grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-3 " id="sort">
                                <FreqLikeSelect
                        ...
                        <div className="mt-5">
                            <div className="mt-1 mb-3 grid xl:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-3 " id="sort">
                                <FreqTimeSelect
