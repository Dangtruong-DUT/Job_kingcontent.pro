...
import { faLevelUpAlt, faLevelDownAlt, faRandom, faShareSquare } from "@fortawesome/free-solid-svg-icons";
...
function FreqShareSelect(props) {
    const { freqShareToFilter, isDisabledFreqShare, setRelationShipFilter } = props;
