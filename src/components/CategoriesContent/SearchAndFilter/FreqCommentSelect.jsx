...
import { faLevelUpAlt, faLevelDownAlt, faRandom, faComment } from "@fortawesome/free-solid-svg-icons";
...
function FreqCommentSelect(props) {
    const { freqCommentToFilter, isDisabledFreqComment, setRelationShipFilter } = props;
