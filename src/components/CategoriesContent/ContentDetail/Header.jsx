    ...
    return (
        <div className="p-3 flex items-start justify-between ">
            ...
            <div className="flex gap-2">
                {writed && (
                    <span className="rounded-md flex items-center p-0 m-0 cursor-pointer" onClick={handelWritePost}>
                        <svg
                ...
                <span className="rounded-md flex items-center p-0 m-0 cursor-pointer" onClick={closePopup}>
                    <FaWindowClose style={{ width: "32px", height: "32px" }} color="red" />
                </span>
                <a href={post_permalink} target="_blank">
                    <span className="rounded-md flex items-center p-0 m-0">
                        <AiFillFacebook style={{ width: "36px", height: "36px" }} className="text-editor-facebook" />
                    </span>
                </a>
            </div>
        </div>
