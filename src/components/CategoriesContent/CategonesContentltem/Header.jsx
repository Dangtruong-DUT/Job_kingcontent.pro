...
function Header(props) {
    const { fanpageName, createdDate, fb_id, page = "", page_avatar = "", source_type = "" } = props;
        ...
        <div className="p-3 flex items-start justify-between ">
            ...
            <div className="mx-3 flex flex-grow items-start flex-col">
                {page === "ads" ? (
                    ...
                    <h3 className="text-sm text-blue-700 font-semibold truncate w-36">Tên người dùng/Trang/Nhóm</h3>
                ) : (
                    <h3 className="text-sm text-blue-700 font-semibold truncate w-36">{fanpageName}</h3>
                )}
                ...
                {page === "ads" ? (
                    ...
                    <span className="m-1 px-1 text-xs text-gray-700 font-medium bg-blue-50">Vừa xong</span>
