...
function Footer(props) {
    ...
    let row = (
        <div className="flex items-center  ">
            ...
            <span className="w-full h-full inset-0 text-center align-middle text-base font-medium">1</span>
        </div>
    );
    if (page === "contentLikedPage" || page === "specialFollowPage") {
        row = (
            <div className="flex justify-end">
                {page === "specialFollowPage" ? (
                    <AiFillHeart className="w-7 h-7" fill="pink" onClick={onShowHashtag} />
                ) : (
                    <TextStyle
            ...
            <div className="flex justify-between gap-5 items-center py-3">
                {FooterList.map((item, index) => (
                    <div className="flex items-center gap-1" key={index}>
                        ...
                        <label htmlFor="content-like" className="text-base text-gray-800 font-medium">
