...
const DefaultModalOverlayList = [
    ...
    { icon: FaBook, title: "ThÃ­ch", action: "SAVE_LIKED_CONTENT" },
    { icon: MdAccessTime, title: "LÃªn lá»‹ch", action: "SCHEDULE_CONTENT" },
...
const ModalOverlayList_2 = [
    ...
    { icon: FaRegEdit, title: "Soáº¡n tháº£o", action: "CREATE_CONTENT" },
    { icon: MdAccessTime, title: "LÃªn lá»‹ch", action: "SCHEDULE_CONTENT" },
    { icon: TiMinusOutline, title: "Bá» thÃ­ch", action: "DISLIKE" },
    { icon: BiTag, title: "Thay Ä‘á»•i hashtag", action: "EDIT_TAG" },
    { icon: renderVideoGenIcon, title: "Táº¡o Video AI", action: "SET_SCRIPT_VIDEO_AI" },
];
