...
import SearchForm from "@/containers/Homepage/components/SearchForm";
...
const Homepage = (props) => {
    ...
    const { searchVideos: searchVideosDouYin = null } = useSelector((state) => state.douyins);
    ...
    useEffect(() => {
        if (
            !searchVideosDouYin ||
            (searchVideosDouYin && searchVideosDouYin.videos && searchVideosDouYin.videos.length === 0)
        ) {
                    ...
                    <div className="sm:w-full md:w-8/12 lg:w-8/12">
                        <div className="homeScheduleContents rounded-lg shadow-md p-5 bg-white mb-5">
                            <div className="flex items-center justify-between py-2 px-5">
                                <h2 className="font-bold uppercase text-base">Lịch đăng bài hôm nay</h2>
                        ...
                        <div className="homeSpecialFanpages rounded-lg shadow-md p-5 bg-white mb-5">
                            <div className="flex items-center justify-between py-2 px-5">
                                <h2 className="font-bold uppercase text-base">Đang theo dõi đặc biệt</h2>
                                <span className="text-blue-500 underline font-bold">
                                    {" "}
                        ...
                        <div className="trendingTikTok rounded-lg shadow-md p-5 mt-5 bg-white mb-5">
                            <div className="flex items-center justify-between py-2 px-5">
                                <h2 className="font-bold uppercase text-base">Video Tiktok đang thịnh hành</h2>
                                <span className="text-blue-500 underline font-bold">
                        ...
                        <div className="trendingDouyin rounded-lg shadow-md p-5 mt-5 bg-white mb-5">
                            <div className="flex items-center justify-between py-2 px-5">
                                <h2 className="font-bold uppercase text-base">Video Douyin đang thịnh hành</h2>
                                <span className="text-blue-500 underline font-bold">
                        ...
                        <div className="trendingInstagram rounded-lg shadow-md p-5 mt-5 bg-white mb-5">
                            <div className="flex items-center justify-between py-2 px-5">
                                <h2 className="font-bold uppercase text-base">Bài viết Instagram đang thịnh hành</h2>
                                <span className="text-blue-500 underline font-bold">
