            ...
            {isHome && (
                <div className="flex-1 text-center">
                    <div className="px-6 w-auto rounded-lg bg-white relative m-auto">
                        ...
                        />
                        <button className="absolute top-0 right-0 w-11 h-11 rounded-r-md" onClick={handleOnSearch}>
            ...
            {!isHome && (
                <div className="h-10 px-6 py-2 w-2/3 rounded-lg bg-blue-50 relative">
                    <input
                        ...
                        onChange={(evt) => setKeyword(evt.target.value)}
                    />
                    <button className="absolute top-2 right-4 w-6 h-6" onClick={handleOnSearch}>
