        ...
        {showNoResults && (
          ...
          >
            <p className="text-center w-full">
              Ná»™i dung nÃ y chÆ°a cÃ³, vui lÃ²ng <a href='https://fb.com/kingcontent.pro' target='_blank' className='text-primary underline'>Báº¤M VÃ€O ÄÃ‚Y</a> Ä‘á»ƒ Ä‘á» xuáº¥t quáº£n trá»‹ viÃªn xá»­ lÃ½!
            </p>
          </div>
        )}
      </div>
