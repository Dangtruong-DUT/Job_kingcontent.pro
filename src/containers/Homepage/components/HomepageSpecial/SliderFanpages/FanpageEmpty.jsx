...
const FanpageEmpty = () => {
    return (
        <div className="singleContent  flex gap-2 items-center relative bg-gray-100 rounded-3xl mb-1 mr-2 p-2 cursor-pointer">
            ...
            <div className="absolute w-full ">
                <div className="flex mt-2 justify-center">
                    <Link to={"/danh-sach-page"}>
                        <button title="Click để tạo lịch đăng bài mới">
